...
export interface SpawnOptions {
  ...
  model?: string;
  cursorModel?: string;
  permissionMode?: "prompt" | "allow-once" | "deny";
  maxTurns?: number;
...
// Preserve the upstream global key so existing workspace/permission companions
// can consume this vendored implementation without loading a second core.
