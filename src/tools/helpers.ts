...
export function buildDetails(
  base: Pick<AgentDetails, "backend" | "displayName" | "description" | "subagentType" | "modelName" | "tags">,
  record: {
    toolUses: number;
    startedAt: number;
    completedAt?: number;
  ...
  return {
    ...
    turnCount: base.backend === "pi" ? record.turnCount : undefined,
    maxTurns: base.backend === "pi" ? record.maxTurns : undefined,
